<aside class="flex-col w-64 h-screen px-5 py-6 overflow-y-auto bg-white border-r dark:bg-gray-900 dark:border-gray-800 hidden md:block">
    ...
    <nav class="mt-8 space-y-6 text-sm font-medium text-gray-700 dark:text-gray-200">
        ...
        <!-- Results with Collapsible Submenu -->
